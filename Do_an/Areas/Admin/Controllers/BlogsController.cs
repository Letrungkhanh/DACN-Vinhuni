...
namespace Do_an.Areas.Admin.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        public BlogsController(QlBhqContext context)
        {
            _context = context;
        }
        ...
        {
            var qlBhqContext = _context.TbBlogs.Include(t => t.Account).Include(t => t.Category);
        ...
        public async Task<IActionResult> Create([Bind("BlogId,Title,Alias,CategoryId,Description,Detail,Image,SeoTitle,SeoDescription,SeoKeywords,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,AccountId,IsActive")] TbBlog tbBlog)
        {
            ...
            {
                tbBlog.Alias = Do_an.Utilities.Functions.TitleSlugGenerationAlias(tbBlog.Title);
                _context.Add(tbBlog);
